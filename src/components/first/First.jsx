        ...
        <div className='container'>
           ...
           <div className='cards'>
            ...
            <div className="made">
                ...
                <a className='aa' href="https://www.instagram.com/myrza.888/?hl=ru"><h4>Zhyrgalbekov Myrza</h4></a>
                <a className='aa' href="https://www.instagram.com/52herthz/?hl=ru"><h4>Sharipov Alisher</h4></a>
            </div>
        </div>
    )
}
